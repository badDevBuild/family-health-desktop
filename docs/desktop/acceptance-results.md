...
> 历史基线：本页测试数量、旧链路调用方式和“图像真实模型尚未执行”等描述停留在 9 月 19 日；当前 Lean V3 的实际模型调用、纯合成图像 P01 及剩余 NOT_RUN 项请以 [Lean V3 真实模型回执](lean-v3-real-model-synthetic-smoke-2026-09-22.md) 为准。下列旧链路 PASS 不代表 Lean V3 的医学质量或安装包端到端验收。
